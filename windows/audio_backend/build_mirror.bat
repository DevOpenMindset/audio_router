...
echo Compiling...
cl.exe /nologo /O2 /EHa /MD /DAUDIO_BACKEND_EXPORTS /c "C:\Users\ahmed\audio_router\windows\audio_backend\audio_backend.cpp" /Fo:"C:\Users\ahmed\audio_router\windows\audio_backend\audio_backend.obj"
if errorlevel 1 ( echo COMPILE FAILED & exit /b 1 )
echo Linking...
link.exe /nologo /DLL /OUT:"C:\Users\ahmed\audio_router\windows\audio_backend\audio_backend.dll" "C:\Users\ahmed\audio_router\windows\audio_backend\audio_backend.obj" ole32.lib propsys.lib runtimeobject.lib Shell32.lib Gdi32.lib User32.lib Advapi32.lib ^
