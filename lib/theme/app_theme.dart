...
class AppColors {
  ...
  static Color get active   => isDarkTheme
      ? const Color(0xFF22C55E) : const Color(0xFF16A34A);
  static Color get inactive => isDarkTheme
      ? const Color(0xFF52525B) : const Color(0xFFB0B5BF);
  ...
  static Color getAppColor(String processName) {
    final n = processName.toLowerCase();
    if (n.contains('spotify')) return spotify;
    if (n.contains('discord')) return discord;
    if (n.contains('chrome') || n.contains('firefox') ||
        n.contains('brave')  || n.contains('edge')) return chrome;
    if (n.contains('teams')) return teams;
...
class AppTheme {
  ...
  static Typography get _typography => Typography.raw(
    ...
    bodyStrong: inter(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
    bodyLarge:  inter(fontSize: 14, color: AppColors.textPrimary),
    subtitle:   inter(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
    title:      inter(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
    titleLarge: inter(fontSize: 28, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
    display:    inter(fontSize: 40, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
  );
  ...
  static FluentThemeData get current => FluentThemeData(
    ...
    dialogTheme: ContentDialogThemeData(
      ...
      titleStyle: inter(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
